...
class SQLNet(nn.Module):
    ...
    def forward(self,model_bert, tokenizer, q, col, col_num, gt_where = None, gt_cond=None, reinforce=False, gt_sel=None, gt_sel_num=None):
        ...
        #print(q)
        #print(col)
        q1, col1 = char_base_to_raw_text(q,col)
        x_emb_var, x_len ,col_inp_var, col_name_len, col_len= gen_ques_emb(model_bert, tokenizer,q1, col1)

        #print(x_emb_var.size())
        #print(col_inp_var.size())
        #print(x_len)
        #print(col_name_len)
        #print(col_len)
        #print(col_num)
